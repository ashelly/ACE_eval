...
if(v=e&o/2){t=7;k^=v;while(i=k&k-1)k=i;}else
if(v=o&o-1){t=6;v/=2;k=o/2^v;}else if(e&&o){t=6;v=o/2;k=(i=e&e-1)?i:e;}
else{L(4){X=1<<i;C=((h[X&7]-(k&X))/X&7)&7;if(C>3){k=h[X&7];t=5;break;}}
k&=-64;v=k|k>>26&16;L(4)v&=v*4;if(v){t+=4;k=v&=~(v/4);}else
if(i=t)while(C-->4)v=k&=k-1;else
if(v=o/2)t=3;else if(e){o=e&e-1;v=(i=o&o-1)?o:e;t=1+(o>0);}k^=v;k&=k-1;k&=k-(i==0);}
c(v);v=C/8;c(k);return t<<28|v<<13|C/8;}
